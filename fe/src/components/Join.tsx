  ...
  return (
    <div className='flex flex-col items-center justify-center gap-6 animate-slideInUp'>
      ...
      <div className='text-center mb-2'>
        <h1 className='font-doto text-2xl font-bold text-gradient-green'>Join an Existing Room</h1>
        <p className='text-sm text-zinc-500 font-doto mt-1'>Enter the room ID shared with you</p>
      </div>
      ...
      <div className='w-full space-y-4'>
        ...
        <div className={`transition-all duration-300 ${focusedField === 'username' ? 'transform scale-105' : ''}`}>
          <input 
            type="text"
            placeholder='Your Username (e.g., Jane)'
            value={username}
